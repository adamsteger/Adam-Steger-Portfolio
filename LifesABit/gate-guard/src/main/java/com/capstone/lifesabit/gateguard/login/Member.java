...
public class Member {
  ...
  public boolean equals(Member other) {
    ...
    return this.uuid.equals(other.uuid) &&
           ...
           this.saltedHashedPassword.equals(other.saltedHashedPassword) &&
  ...
  public boolean isAdmin() {
    return ((type == MemberType.OWNER) || (type == MemberType.ADMIN));
  }

  public boolean isOwner() {
    return (type == MemberType.OWNER);
  }
  ...
  public static enum MemberType { USER, ADMIN, OWNER };
}
